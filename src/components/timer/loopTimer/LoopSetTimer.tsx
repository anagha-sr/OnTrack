...
function LoopSetTimer({
  ...
  const { workHours, workMinutes, workSeconds, restHours, restMinutes, restSeconds } = formatTime();
  ...
  return <div className="timer-display flex flex-col">
     <div className={`timer-display flex gap-2`}>
<fieldset>
...
<fieldset>
  <legend>Rest Duration</legend>
        <div className="flex flex-col">
          <label htmlFor="rest-hours">Hours</label>
          <input
            id="rest-hours"
            type="number"
            value={restHours}
